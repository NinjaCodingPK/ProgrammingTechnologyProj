...
/**
 * Method redirects user to the web-page for showing list of developers connected
 * with current project.
 * @author wookie
 */
public class ShowProjectDevsCommand extends Command{
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) 
        ...
        request.setAttribute(Attributes.PERSON_PROJECT_LIST, 
        		serviceFactory.getPersonProjectService().fetchDevs(
        				extractor.extractInt(request, Attributes.PROJECT_ID)));
                
        return WebPages.DEV_LIST_PAGE;
    }
